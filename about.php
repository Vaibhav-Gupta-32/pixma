...
<!-- About Section End -->
    ...
    <div class="section-padding funfact" data-bg-image="assets/images/funfact/funfact-bg.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 wow fadeIn" data-wow-duration="1.5s" data-wow-delay=".1s">
                    <!-- Heading Start -->
                    <div class="heading-one">
                        ...
                        <p>At Pixma, we believe that every presentation should be a memorable experience, which is why we blend cutting-edge technology with user-friendly designs. Our team of experts is committed to understanding your unique needs, delivering solutions that not only meet your expectations but elevate your entire presentation experience.</p>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <div class="testimonial-two-single">
                                    ...
                                    <p class="text">"This company provided outstanding service! Their innovative approach and attention to detail truly made a difference. Highly recommend!"</p>
                                    <div class="user">
                                        <div class="user-image">
                                            <img src="assets/images/testimonial/user-2.png" alt="UserImage">
                                        </div>
                                        <div class="user-meta">
                                            <span class="name">Rajesh Verma</span>
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="testimonial-two-single">
                                    ...
                                    <p class="text">"Professional and dedicated team! They exceeded my expectations by delivering top-notch solutions that helped scale my business efficiently."</p>
                                    <div class="user">
                                        <div class="user-image">
                                            <img src="assets/images/testimonial/user-3.png" alt="UserImage">
                                        </div>
                                        <div class="user-meta">
                                            <span class="name">Pooja Sharma</span>
