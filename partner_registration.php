            ...
            <div class="col-md-12 mb-30 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".3s">
                <form id="contact-form" class="contact-form" action="https://ethemestudio.com/demo/avers/assets/php/contact.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            <input type="email" placeholder="Office Address" name="email">
                        </div>
                        <div class="col-lg-6 mb-3">
                            <input type="email" placeholder="Billing Address" name="email">
                        </div>
                        <div class="col-lg-6 mb-3">
                            <input placeholder="Phone / Fax No." name="phone">
                        </div>
                        <div class="col-lg-6 mb-3">
                            <input type="email" placeholder="Your email" name="email">
                        </div>
                        <div class="col-lg-6 mb-3">
                            <input placeholder="Type of Company" name="subject">
                        </div>
                        <div class="col-12 mb-3">
                            <!-- <textarea name="message" placeholder="Write your comment here"></textarea> -->
                            <select class="form-select" name="name_of_company" id="" style="color: #808087;">
